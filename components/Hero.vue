<template>
    <div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-0 text-800">
            <div class="p-6 text-center md:text-left flex items-center">
                <section>
                    ...
                    <p class="mt-0 mb-4 text-700 leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
            ...
            <div class="overflow-hidden">
                <img src="/assets/demo/images/blocks/hero/hero-1.png" alt="Image" class="md:ml-auto block md:h-full"
